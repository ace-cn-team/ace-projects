...
public class EntityConfigInfoServiceImpl implements EntityConfigInfoService {

    private Map<String, EntityConfigInfo<Entity>> entityServiceInfoMap;

    @Override
    public EntityConfigInfo<Entity> getById(String id) {
