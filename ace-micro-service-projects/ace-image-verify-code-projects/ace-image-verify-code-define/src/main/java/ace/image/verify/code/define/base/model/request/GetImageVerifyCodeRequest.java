...
public class GetImageVerifyCodeRequest {
    @ApiModelProperty(value = "图片验证码图片宽度,默认75", required = true)
    private Integer imageWidth = 75;
    @ApiModelProperty(value = "图片验证码图片高度，默认30", required = true)
    private Integer imageHeight = 35;
